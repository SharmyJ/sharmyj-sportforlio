...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2024 at 10:49 AM
...
(1, 'Echo \"hello world\";', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.', '1716193039850fd18d-84cc-4a36-95b2-903bb660ad75-enigmatic-beauty-with-violet-eyes-female-purple-anime-pfp-4.png', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ');
...
(1, 'Sharmaine Tagalag', '1716193153850fd18d-84cc-4a36-95b2-903bb660ad75-enigmatic-beauty-with-violet-eyes-female-purple-anime-pfp-4.png', 'sharmaine.tagalag@neu.edu.ph', 'admin123');
...
(1, '001 Pasay City, Manila', 'sharmaine.tagalag@neu.edu.ph', '0987654321');
...
(1, 'Sharmaine Joy Tagalag', 'Frontend Developer | UI/UX Designer', 'on');
...
(5, 'Fullname', 'Sharmaine Joy Tagalag'),
(6, 'Birth Date', 'October 4, 2002'),
(7, 'Course', 'Freelance, Developer');
...
(22, 'Education', 'College Graduate', '2021 - 2024', 'PUP', 'Bachelor of Science in Information and Technology Major in Web Developer'),
(26, 'Education', 'Senior High Schoool', '2019 - 2021', 'Pasay National High School', 'STEM - Strand'),
(29, 'Education', 'Master\\\'s Degree', '2024', 'PUP', 'CPE');
...
(1, 'Sharmaine Portfolio', '', '', '1716180303portfolio.png');
...
(1, '1716190129header-background.jpg');
